//! BrightToDo - Tauri Application Library
//!
//! This module contains the core functionality for the BrightToDo desktop application,
...
pub fn run() {
    ...
    info!("Starting BrightToDo application...");
