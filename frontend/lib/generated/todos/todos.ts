...
export const useCreateTodoApiTodosPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    /**
 * 生成待办 AI 时间优化预览
 * @summary Optimize Todo Time
 */
export type optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse200 = {
  data: TodoTimeOptimizationResponse
  status: 200
}

export type optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponseSuccess = (optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse200) & {
  headers: Headers;
};
export type optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponseError = (optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse422) & {
  headers: Headers;
};

export type optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse = (optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponseSuccess | optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponseError)

export const getOptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostUrl = (todoId: number,) => {




  return `/api/todos/${todoId}/time-optimization`
}

export const optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost = async (todoId: number, options?: RequestInit): Promise<optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse> => {

  return customFetcher<optimizeTodoTimeApiTodosTodoIdTimeOptimizationPostResponse>(getOptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostUrl(todoId),
  {
    ...options,
    method: 'POST'
...
export const getOptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>, TError,{todoId: number}, TContext>, request?: SecondParameter<typeof customFetcher>}
): UseMutationOptions<Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>, TError,{todoId: number}, TContext> => {

const mutationKey = ['optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>, {todoId: number}> = (props) => {
          const {todoId} = props ?? {};

          return  optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost(todoId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type OptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostMutationResult = NonNullable<Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>>

    export type OptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostMutationError = HTTPValidationError

    /**
 * @summary Optimize Todo Time
 */
export const useOptimizeTodoTimeApiTodosTodoIdTimeOptimizationPost = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>, TError,{todoId: number}, TContext>, request?: SecondParameter<typeof customFetcher>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof optimizeTodoTimeApiTodosTodoIdTimeOptimizationPost>>,
        TError,
        {todoId: number},
        TContext
      > => {
      return useMutation(getOptimizeTodoTimeApiTodosTodoIdTimeOptimizationPostMutationOptions(options), queryClient);
    }
    /**
 * 获取单个待办
 * @summary Get Todo
